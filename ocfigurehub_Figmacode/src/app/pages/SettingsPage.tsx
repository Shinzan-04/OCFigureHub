...
export function SettingsPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 md:px-8 py-8 sm:py-10 md:py-14">
      {/* Page header */}
      <div className="mb-10">
        <div
        ...
        >
          ...
          <div className="flex flex-col gap-5">
            ...
            <button
              ...
              className="w-full sm:w-auto sm:self-end px-5 py-2.5 rounded-xl text-sm font-semibold transition-opacity hover:opacity-90 disabled:opacity-50 flex items-center justify-center gap-2"
              style={{ backgroundColor: '#8B5CF6', color: '#fff' }}
            >
              {isSavingProfile ? (
                <>
